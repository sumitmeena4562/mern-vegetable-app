            ...
            <form onSubmit={handleSubmit} className="relative z-10 space-y-6">
              ...
              <div className="pt-4">
                <button
                  ...
                  className={`w-full flex justify-center items-center gap-2 py-4 px-4 border border-transparent rounded-2xl shadow-lg text-lg font-bold text-white bg-gradient-to-r transition-all transform active:scale-[0.98] ${loading || isBlocked
