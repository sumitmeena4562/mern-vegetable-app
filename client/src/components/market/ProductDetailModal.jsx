            ...
            <div className="border-t border-slate-100 px-5 py-4 space-y-3 bg-slate-50/50">
                ...
                <div className="flex gap-2.5">
                    <Button
                        ...
                        icon={<span className="material-symbols-outlined text-base">shopping_cart</span>}
                    >
                        Add to Cart
                    </Button>
                    <Button
                        ...
                        isLoading={ordering}
                        size="md"
                        className="flex-1 rounded-xl text-xs shadow-lg shadow-indigo-200"
                        icon={!ordering && <span className="material-symbols-outlined text-base">flash_on</span>}
                    >
                        Order Now
                    </Button>
                </div>
