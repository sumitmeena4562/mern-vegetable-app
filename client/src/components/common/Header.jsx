                ...
                <div className="absolute top-full mt-2 w-48 bg-white dark:bg-[#1f3b29] rounded-xl shadow-lg border border-gray-100 dark:border-gray-800 overflow-hidden z-50">
                  {languages.map((lang) => (
                    <button
                      ...
                      className={`w-full px-4 py-3 text-left hover:bg-[#f0fdf4] dark:hover:bg-[#14532d] transition-colors ${
          ...
          <div className="md:hidden absolute top-20 left-0 right-0 bg-white dark:bg-[#112117] border-b border-gray-100 dark:border-gray-800 shadow-lg">
            <div className="px-4 py-6 space-y-4">
              ...
              <div className="pt-4 border-t border-gray-100 dark:border-gray-800">
                ...
                {/* Mobile Login Button */}
                <button className="w-full px-6 py-3 rounded-full bg-primary text-white text-sm font-bold shadow-lg shadow-primary/30 hover:bg-green-700 transition-colors">
                  Login
                </button>
              </div>
            </div>
